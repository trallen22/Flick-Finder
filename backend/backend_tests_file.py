...
# this tests signs a user up; should return success 
...
# this tests logging in a real user; should return success 
system('curl -X POST http://127.0.0.1:5000/sign-up -d \'{ "username": "ta1", "password": "123" }\' -H "Content-Type: application/json"')